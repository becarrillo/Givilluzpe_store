...
const NavMobileDevicesMenu = () => {
    ...
    return (
        <nav className="grid grid-rows-5 rounded-2xl bg-zinc-200 fixed top-28 w-11/12 opacity-80 left-1">
            <ul className="row-span-5 divide-y divide-zinc-600 w-5/6 sm:w-full">
                <li className="py-1 text-center bg-white ring-1 ring-zinc-600 rounded-2xl shadow-lg 
                shadow-french-rose hover:bg-cyan-200 active:cursor-pointer hover:text-french-rose"
                >
                    <Link to="/#" className="text-zinc-600 my-0 px-32 font-semibold italic hover:text-french-rose">Inicio</Link>
                </li>
